...
instance_launch_options = oci.core.models.LaunchOptions(boot_volume_type = "PARAVIRTUALIZED")

instance_details = compute_client.launch_instance(availability_domain = availability_domain,
